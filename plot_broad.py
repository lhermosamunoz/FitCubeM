...
def broad_plot(parentFold,l,data_cor,meth,trigger,linresu,refresu,fullresu,broadresu,l1,l2,l3,l4,l5,l6,l7,l8,l9,l10,l11,l12,l13,l14,std0,std1):
    ...
    if trigger=='Y':
        ...
        np.savetxt(parentFold+'v_sig_adj_1Cb.txt',
                       np.c_[vS2,evS2,vbS2,evbS2,sigS2,esigS2,sigbS2,esigbS2], 
                       ('%8.5f','%8.5f','%8.5f','%8.5f','%8.5f','%8.5f','%8.5f','%8.5f'),
                       header=('v_ref\tev_ref\tv_broadH\tev_broadH\tsig_ref\tesig_ref\tsig_broadH\tesig_broadH'))
...
#    	    plt.plot(l,(linresu.values['slope']*l+linresu.values['intc']),c='gold',linestyle=(0, (5, 8)),label='Linear fit')
        plt.plot(l,bgaus1+lin_data_fin,c='g',linestyle='-')
        plt.plot(l,bgaus2+lin_data_fin,c='g',linestyle='-')
        ...
        plt.text(0.9,0.9,'B',color='darkviolet',transform=frame1.transAxes,fontsize=21)
...
############################################################################################################################################
        ...
        np.savetxt(parentFold+'v_sig_adj_2Cb.txt',
                       np.c_[vS2,evS2,v2S2,ev2S2,vbS2,evbS2,sigS2,esigS2,sig2S2,esig2S2,sigbS2,esigbS2],
        ...
        plt.plot(l[std0:std1],data_cor[std0:std1],'k',linewidth=1.)	     # Initial data
#	    plt.plot(l,(linresu.values['slope']*l+linresu.values['intc']),c='gold',linestyle=(0, (5, 8)),label='Linear fit')
        plt.plot(l,b2gaus1+lin_data_fin,c='g',linestyle='-')
        plt.plot(l,b2gaus2+lin_data_fin,c='g',linestyle='-')
        ...
        plt.xlim(l[0],l[-1])
        plt.gca().yaxis.set_major_locator(plt.MaxNLocator(prune='lower'))
        plt.text(0.81,0.9,'N',color='g',transform=frame1.transAxes,fontsize=21)
        ...
        plt.text(0.90,0.9,'+',color='k',transform=frame1.transAxes,fontsize=21)
        plt.text(0.93,0.9,'B',color='darkviolet',transform=frame1.transAxes,fontsize=21)
